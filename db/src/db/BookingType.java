...
//            DataLogger.writeLog(fname, query);
    ...
    private static String generateNumber()
    {
        ...
        try
        {
            ...
            { db.closeConnection();return "A000000";}
    ...
    public static String addBooking(String phone,String staff,String total,String discount,String finalAmount,String issueDt,String returnDt,String status, String category, TableModel t)
    {
        DatabaseType db=new DatabaseType();
...
//                DataLogger.writeLog(fname, transitionQuery);
    ...
    static void CancelBooking(String rcpNo, String prevRcpt) {
         String query="Update booking set prev='"+prevRcpt+"'" ;
        String opt=",delDate = CURRENT_TIMESTAMP ";
