     ...
     //   System.out.println("**********************************"+pageIndex+"**********************************");
        if (isClosing) {
            for (int i = 0; i <= pageline; i++) {
                ...
                srNo = i + (pageIndex * NumberOfLine);
                if (srNo <= Printable.length - 6) {

                    printString(String.valueOf(srNo + 1), y_axis, g, 5); // SR No
                } else {
                //   System.out.println("srNo= "+srNo+" /////// prNo="+(Printable.length-4));

                    printString(" ", y_axis, g, 5); // SR No
                }
