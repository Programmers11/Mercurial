...
public class DatabaseType {
    ...
    public static BaseClass master;
    ...
    public int insert(String query)
    {
     ...
     public int insertBooking(String query) throws Exception
    {
        int x=1;
        try 
        {
        ...
        {
             JOptionPane.showMessageDialog(null, "Error: Wait! Click ok to continue.","Oops",JOptionPane.ERROR_MESSAGE);
